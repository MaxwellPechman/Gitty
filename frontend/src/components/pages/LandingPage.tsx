    ...
    return (
        <div className="w-screen bg-gradient-to-br from-gray-950 to-gray-900">
            ...
            <div className="text-white text-center overflow-auto">
                ...
                <br/>
                <button className="bg-black border-white mr-7 w-56 hover:bg-gray-900" onClick={() => navigate("/register")}>Register</button>
                <button className="bg-white border-white text-black w-56 ml-7 hover:bg-gray-400" onClick={() => navigate("/login")}>Login</button>
            </div>
            <div className="flex flex-row w-screen mt-5 justify-between">
